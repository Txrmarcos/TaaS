...
import { idlFactory } from './bot-plan.did.js';
export { idlFactory } from './bot-plan.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BOT_PLAN;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bot-plan.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bot-plan canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bot-plan.did.js")._SERVICE>}
 */
export const bot_plan = createActor(canisterId);
