...
import { idlFactory } from './round-table.did.js';
export { idlFactory } from './round-table.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ROUND_TABLE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./round-table.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the round-table canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./round-table.did.js")._SERVICE>}
 */
export const round_table = createActor(canisterId);
