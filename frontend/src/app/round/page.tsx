...
export default function RoundtablePage() {
  ...
  const submitProposal = async () => {
    ...
    try {
      const id = await roundtableActor.propose_source(name, url, prLink, desc); // 🟢 Adiciona prLink
  ...
  const formatStatus = (status: Proposal["status"]) => {
    if (status.Approved !== undefined) return { text: "Aprovada", color: "text-green-400", icon: CheckCircle };
    if (status.Rejected !== undefined) return { text: "Rejeitada", color: "text-red-400", icon: XCircle };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              <button className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all duration-200 shadow-lg">
                🔎 Verificar
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-center mb-8">
          <button
            ...
            className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl hover:from-purple-600 hover:to-pink-600 transition-all duration-200 shadow-lg flex items-center space-x-2 group"
          >
              ...
              <div className="space-y-6">
                ...
                <div className="flex space-x-4">
                  <button
                    ...
                    className="flex-1 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-xl hover:from-green-600 hover:to-emerald-600 transition-all duration-200 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
                  >
        ...
        <div className="mb-8">
          ...
          {proposals.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-gray-400 text-lg">Nenhuma proposta ainda</p>
              <p className="text-gray-500 text-sm mt-2">Seja o primeiro a propor uma fonte!</p>
            </div>
          ) : (
